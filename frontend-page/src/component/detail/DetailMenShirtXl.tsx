...
function DetailMenShirtXl({
  ...
  const getData = async () => {
    ...
    const data = await axios.get(
      `https://shop-pdxc.onrender.com/product/men/shirt/detail/${productId}`
    );
    setDetail([data.data]);
              ...
              <div className="p-2 flex flex-col items-center text-center">
                ...
                <div className="collapse bg-base-200 mt-2 w-80">
                  ...
                  <div className="collapse-content">
                    {shirt.overview.map((data: string) => {
                      return (
                        <>
                          <p>- {data}</p>
                        </>
...
export default DetailMenShirtXl;
